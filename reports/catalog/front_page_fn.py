...
def add_front_page_fn(
    ...
    # Fonts (prefer Kokila if present)
    ...
    header_ranges_to_border = [
        'B9:B11', 'C9:N9', 'C10:D10', 'E10:F10',
        'G10:H10', 'I10:J10', 'K10:N10',
    ...
    for cell_ref, text in [
        ('C10', "महिन्याचा पहिला दिवस"), ('E10', "प्रवेश दिलेले"),
        ('G10', "नाव कमी / तुकडी बदल"), ('I10', "शेवटच्या दिवशी"),
        ('K10', "मागासवर्गीय")
    ]:
        c = ws[cell_ref]; c.value = text; c.font = table_subheader_font; c.alignment = table_center

    for cell_ref, text in {
        'C11': "मुले", 'E11': "मुले", 'G11': "मुले", 'I11': "मुले", 'L11': "मुले",
        'D11': "मुली", 'F11': "मुली", 'H11': "मुली", 'J11': "मुली", 'M11': "मुली",
        'K11': "प्रवर्ग", 'N11': "एकूण"
    }.items():
        c = ws[cell_ref]; c.value = text; c.font = table_subheader_font; c.alignment = table_center

    for i, text in enumerate([
        "मोफत शिक्षण", "बी.सी. एकदा नापास", "प्रा. शिक्षक पाल्य",
        "मा. शिक्षक पाल्य", "माजी सैनिक", "आजी सैनिक", "दार", "एकूण", "एकूण"
    ], start=12):
        c = ws[f'B{i}']; c.value = text; c.font = table_label_font; c.alignment = table_left

    for i, text in enumerate([
        "अनु. जाती ( SC )", "अनु. जमाती (ST )", "भ. वि. जा. (NT)",
        "विशेष मागास (SBC)", "इतर मागास (OBC)", "खुला (OPEN)",
        "एकूण :-", "पटावर :-", "सरासरी हजेरी :-"
    ], start=12):
        c = ws[f'K{i}']; c.value = text; c.font = table_label_font; c.alignment = table_left

    # Main table body and footer scaffolding
    ...
    for r in [
        'B12:B18', 'B19', 'B20',
        'C12:D18', 'C19:D19', 'C20:D20',
        'E12:F18', 'E19:F19', 'E20:F20',
        'G12:H18', 'G19:H19', 'G20:H20',
        'I12:J18', 'I19:J19', 'I20:J20',
        'K12:K18', 'K19', 'K20',
        'L12:N18', 'L19:N19', 'L20:N20'
    ]:
        apply_medium_box_border(ws, r)
    ...
    division_name = report_data.get('division_name_mr', '')
    c = ws['L7']; c.value = f"तुकडी: {division_name}"; c.font = info_font; c.alignment = table_center
